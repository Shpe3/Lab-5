...
/**
 * Команда 'filter_contains_part_number'. Фильтрация продуктов по полю
 * partNumber.
 */
public class FilterContainsPartNumber extends Command {
  ...
  public FilterContainsPartNumber(Console console, CollectionManager collectionManager) {
    super("filter_contains_part_number <PN>",
        "вывести элементы, значение поля partNumber которых содержит заданную подстроку");
  ...
  public boolean apply(String[] arguments) {
    try {
      ...
      if (products.isEmpty()) {
        ...
        console.println(
            "Продуктов, чьи partNumber содержат '" + arguments[1] + "' обнаружено " + products.size() + " шт.\n");
